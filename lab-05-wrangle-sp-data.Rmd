...
**There are two La Quintas in alaska.
...
dn_lq_ny_mindist %>% summarise(mean_dist = mean(closest))
...
**It is most likely to hold true in Texas, as there are far more Denny's and La Quintas next to each other there than in any other state I examined.**
